...
* Automated tests are needed for this module. Any help is appreciated. So far, things have been tested manually and seem to be reasonably ok. Automated tests would probably make life easier :)
