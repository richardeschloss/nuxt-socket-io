...
export default defineNuxtModule({
  setup (moduleOptions, nuxt) {
    ...
    nuxt.options.publicRuntimeConfig.nuxtSocketIO = { ...options }
    if (options.server !== false) {
      ...
      const ioServerOpts = {
        serverInst: http.createServer(), // serverInst can be overridden by options.server.serverInst below
      ...
      nuxt.hook('close', () => ioServerOpts.serverInst.close())
    ...
    includeDeps(nuxt, [
      'deepmerge', 'parseuri', '@socket.io/component-emitter', 'parseqs', 'yeast', 'engine.io-client',
